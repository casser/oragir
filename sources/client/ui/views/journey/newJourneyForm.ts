...
import {selectNewBlock, selectBlock, inputBlock, inputDateTimeLocalBlock, subTitle} from "../../components/Inputs";
...
export class NewJourneyForm{
    ...
    // date 
    dateInputBlock: inputDateTimeLocalBlock;
    ...
    constructor(parent_container: HTMLDivElement) {
        ...
        */
        //
        this.dateInputBlock = new inputDateTimeLocalBlock(
            this.form,
            "date_from",
            "w3-input w3-border",
            "date_from",
